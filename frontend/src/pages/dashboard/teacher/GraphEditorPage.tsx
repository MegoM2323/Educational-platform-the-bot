...
import { GraphEditorTab } from './GraphEditorTab';
...
/**
 * Teacher Graph Editor Page
 * Обертка для GraphEditorTab с sidebar и выбором предмета
 */
        ...
        <SidebarInset>
          <header className="sticky top-0 z-10 flex h-16 items-center gap-4 border-b bg-background px-6">
            ...
            <div className="flex-1">
              <h1 className="text-2xl font-bold">Редактор графа знаний</h1>
            </div>
          </header>
          <main className="p-6">
            {isLoading && (
              ...
              <div className="space-y-6">
                ...
                {selectedSubjectId && (
                  <GraphEditorTab
                    ...
                    subjectName={
                      subjects.find((s: any) => (typeof s === 'object' ? s.id : null) === selectedSubjectId)?.name ||
                      ''
                    }
                  />
                )}
