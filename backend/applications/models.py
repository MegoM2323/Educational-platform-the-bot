...
class Application(models.Model):
    ...
    grade = models.CharField(max_length=10, blank=True, verbose_name='Grade')  # For students
    subject = models.CharField(max_length=100, blank=True, verbose_name='Subject')  # For teachers
    ...
    parent_first_name = models.CharField(max_length=100, blank=True, verbose_name='Parent First Name')
    parent_last_name = models.CharField(max_length=100, blank=True, verbose_name='Parent Last Name')
    parent_email = models.EmailField(blank=True, verbose_name='Parent Email')
    parent_phone = models.CharField(max_length=20, blank=True, verbose_name='Parent Phone')
    parent_telegram_id = models.CharField(max_length=100, blank=True, verbose_name='Parent Telegram ID')
    ...
    generated_username = models.CharField(max_length=150, blank=True, verbose_name='Generated Username')
    generated_password = models.CharField(max_length=128, blank=True, verbose_name='Generated Password')
    parent_username = models.CharField(max_length=150, blank=True, verbose_name='Parent Username')
    parent_password = models.CharField(max_length=128, blank=True, verbose_name='Parent Password')
