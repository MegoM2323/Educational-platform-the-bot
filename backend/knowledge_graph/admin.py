...
class ElementAdmin(admin.ModelAdmin):
    list_display = ['title', 'element_type', 'difficulty', 'estimated_time_minutes', 'max_score', 'is_public', 'created_by']
...
class LessonAdmin(admin.ModelAdmin):
    list_display = ['title', 'subject', 'element_count', 'total_duration_minutes', 'total_max_score', 'is_public', 'created_by']
