...
class BulkNotificationSerializer(serializers.Serializer):
    ...
    recipients = serializers.ListField(
        child=serializers.IntegerField(), help_text="Список ID получателей"
    )
...
class NotificationMarkReadSerializer(serializers.Serializer):
    ...
    mark_all = serializers.BooleanField(
        default=False, help_text="Отметить все уведомления как прочитанные"
    )
...
class ScheduleNotificationResponseSerializer(serializers.Serializer):
    ...
    notification_ids = serializers.ListField(
        child=serializers.IntegerField(), help_text="Created notification IDs"
    )
    count = serializers.IntegerField(help_text="Number of notifications created")
    scheduled_at = serializers.DateTimeField(help_text="Scheduled send time")
...
class CancelScheduledNotificationSerializer(serializers.Serializer):
    ...
    message = serializers.CharField(help_text="Cancellation confirmation message")
...
class NotificationUnsubscribeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ("id", "user", "unsubscribed_at", "ip_address", "user_agent")
