...
export const ParentProfilePage = () => {
  ...
  const handleInputChange = (field: string, value: string) => {
    setFormData((prev) => {
      ...
      // Проверяем изменения по сравнению с начальными данными
  ...
  const handleRemoveAvatar = () => {
    ...
    // Помечаем как изменённое только если был аватар для удаления
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <CardContent className="p-6 flex flex-col items-center gap-4">
                    <Avatar className="w-48 h-48 shadow-lg border-4 border-[hsl(0,0%,96%)]">
                      ...
                      <AvatarFallback
                        ...
                        style={{
                          background: 'linear-gradient(135deg, hsl(30, 80%, 55%), hsl(50, 90%, 60%))',
                        }}
                      >
                        {initials}
                      </AvatarFallback>
            ...
            <div className="lg:col-span-2">
              <Card className="shadow-md">
                <CardHeader>
                  <CardTitle className="text-2xl">Профиль родителя</CardTitle>
                  <CardDescription>
