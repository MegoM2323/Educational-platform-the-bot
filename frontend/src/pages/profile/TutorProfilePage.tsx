...
export const TutorProfilePage = () => {
  ...
  const { user } = useAuth();
  const { profile, isLoading, updateProfile, isUpdating, refetch } = useTutorProfile();
  ...
  const maxSpecializationChars = 500;
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      placeholder="Опишите вашу специализацию и подход к работе..."
                      className="min-h-24 resize-none"
                      maxLength={maxSpecializationChars}
                      rows={4}
                    />
                    <p className="text-xs text-[hsl(240,5%,55%)] text-right">
                      Осталось: {maxSpecializationChars - charCount} символов
                    </p>
                    <p className="text-xs text-[hsl(240,5%,55%)]">
                      Опишите вашу специализацию и подход к работе
                    </p>
                  </div>
