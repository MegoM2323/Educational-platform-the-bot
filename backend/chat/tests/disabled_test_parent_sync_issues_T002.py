"""
DISABLED: Forum functionality requires rearchitecture

Test Suite T002: Parent Synchronization Issues in Forum Chats

ChatRoom.Type.FORUM_SUBJECT и ChatRoom.Type.FORUM_TUTOR были удалены.
Forum chats требуют полной переработки архитектуры.

Оригинально проверяло sync_parent_participants signal:
