...
from .profile_views import (
    ...
    CurrentUserProfileView, ProfileReactivationView, NotificationSettingsView
)
...
urlpatterns = [
    ...
    path('notification-settings/', NotificationSettingsView.as_view(), name='notification_settings_api'),
