...
import { User as UserIcon, Key, Trash2, Plus, LogOut, ChevronLeft, ChevronRight, Search, RotateCcw } from 'lucide-react';
        ...
        <CardContent>
          ...
          <div className="flex items-center justify-between mt-6 pt-4 border-t">
            <div className="text-sm text-muted-foreground">
              Показано {students.length} из {totalCount} студентов
            </div>
            <div className="flex gap-2">
              <Button
                variant="outline"
