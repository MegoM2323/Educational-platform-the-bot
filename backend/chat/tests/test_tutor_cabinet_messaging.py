...
class TestT073ChatInitiation:
    ...
    def test_create_direct_chat_room(self, authenticated_tutor_client):
        ...
        response = authenticated_tutor_client.post('/api/chat/rooms/', {
            'name': 'Test Chat',
            'type': 'direct',
    ...
    def test_send_text_message(self, authenticated_tutor_client, direct_chat_room):
        ...
        response = authenticated_tutor_client.post('/api/chat/messages/', {
    ...
    def test_cannot_send_message_if_not_participant(self, api_client, direct_chat_room, student_user, another_student):
        ...
        api_client.credentials(HTTP_AUTHORIZATION=f'Token {token.key}')
        response = api_client.post('/api/chat/messages/', {
            'room': direct_chat_room.id,
            'content': 'Should fail'
        })
        assert response.status_code in [status.HTTP_403_FORBIDDEN, status.HTTP_400_BAD_REQUEST]

    def test_join_chat_room(self, authenticated_student_client, tutor_user, student_user):
...
class TestT074WebSocketMessages:
    ...
    def test_list_messages_in_room(self, authenticated_tutor_client, direct_chat_room):
        ...
        response = authenticated_tutor_client.get(f'/api/chat/rooms/{direct_chat_room.id}/messages/')
        assert response.status_code == status.HTTP_200_OK

    def test_mark_messages_as_read(self, authenticated_student_client, direct_chat_room):
...
class TestT076MessageEditing:
    ...
    def test_edit_own_message(self, authenticated_tutor_client, direct_chat_room):
        ...
        # Edit message
        response = authenticated_tutor_client.patch(f'/api/chat/messages/{msg.id}/', {
    ...
    def test_cannot_edit_others_message(self, authenticated_tutor_client, authenticated_student_client, direct_chat_room):
        ...
        response = authenticated_student_client.patch(f'/api/chat/messages/{msg.id}/', {
...
class TestT077MessageDeletion:
    ...
    def test_soft_delete_own_message(self, authenticated_tutor_client, direct_chat_room):
    ...
    def test_cannot_delete_others_message(self, authenticated_tutor_client, authenticated_student_client, direct_chat_room):
    ...
    def test_deleted_message_not_in_list(self, authenticated_tutor_client, direct_chat_room):
...
class TestT079ChatHistory:
    ...
    def test_history_excludes_deleted(self, authenticated_tutor_client, direct_chat_room):
...
class TestT080Notifications:
    ...
    def test_unread_message_badge(self, authenticated_tutor_client, authenticated_student_client, direct_chat_room):
...
class TestT082Archive:
    ...
    def test_archive_chat_room(self, authenticated_tutor_client, direct_chat_room):
        ...
        response = authenticated_tutor_client.patch(f'/api/chat/rooms/{direct_chat_room.id}/', {
            'is_active': False
        })
...
class TestT084ForumPostCreation:
    ...
    def test_list_forum_posts(self, authenticated_student_client, forum_room):
        ...
        response = authenticated_student_client.get(f'/api/chat/rooms/{forum_room.id}/threads/')
...
class TestT085ForumReplies:
    ...
    def test_reply_to_forum_post(self, authenticated_student_client, forum_room):
        ...
        response = authenticated_student_client.post('/api/chat/messages/', {
            'room': forum_room.id,
            'thread': thread.id,
    ...
    def test_get_thread_replies(self, authenticated_student_client, forum_room):
        ...
        response = authenticated_student_client.get(f'/api/chat/threads/{thread.id}/messages/')
        assert response.status_code in [status.HTTP_200_OK, status.HTTP_404_NOT_FOUND]
...
class TestT086ForumModeration:
    ...
    def test_pin_forum_post(self, authenticated_tutor_client, forum_room):
        ...
        response = authenticated_tutor_client.patch(f'/api/chat/threads/{thread.id}/', {
            'is_pinned': True
        })
    ...
    def test_cannot_reply_to_locked_post(self, authenticated_student_client, forum_room):
...
class TestT087ForumAnnouncements:
    ...
    def test_announcement_visible_to_all(self, authenticated_student_client, forum_room):
...
class TestSecurityAndPermissions:
    ...
    def test_user_cannot_see_others_private_chats(self, authenticated_student_client, tutor_user, another_student):
        ...
        response = authenticated_student_client.get(f'/api/chat/rooms/{private_room.id}/')
    ...
    def test_leave_chat_room(self, authenticated_student_client, direct_chat_room):
        ...
        response = authenticated_student_client.post(f'/api/chat/rooms/{direct_chat_room.id}/leave/')
        assert response.status_code in [status.HTTP_200_OK, status.HTTP_404_NOT_FOUND]
