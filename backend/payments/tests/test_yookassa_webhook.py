...
class YooKassaWebhookTestCase(TestCase):
    ...
    def test_webhook_without_signature(self):
        ...
        webhook_data = {
            ...
            'object': {
                'id': self.payment.yookassa_payment_id,
                'status': 'succeeded'
            }
        }
    ...
    def test_webhook_processes_payment_data(self):
        ...
        self.assertEqual(payment.raw_response['object']['id'], self.payment.yookassa_payment_id)
    ...
    def test_webhook_status_transitions(self):
        ...
        transitions = [
            (Payment.Status.PENDING, 'payment.waiting_for_capture', Payment.Status.WAITING_FOR_CAPTURE),
            (Payment.Status.WAITING_FOR_CAPTURE, 'payment.succeeded', Payment.Status.SUCCEEDED),
        ]
